...
# Parsing + Configuration Script – AXE UC100 - Rev. A

This **Parsing + Configuration** script is designed for the **AXE UC100** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AXE UC100 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AXE UC100** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
